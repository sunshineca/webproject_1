			...
			//Step 1: Initialize the driver and connect to a SQL server
		     ...
		     sql = "CREATE TABLE USER_VISIT_HISTORY "
	  		 ...
	  		 BufferedReader reader = new BufferedReader(new FileReader(
	  				 "/Users/jing/code/workspace/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_business.json"));
	  		...
	  		reader = new BufferedReader(new FileReader(
	  	  			 "/Users/jing/code/workspace/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_review.json"));
